...
import edu.frcc.csc1061jfa24.MyAVLTree.MyAVLTree1;
import edu.frcc.csc1061jfa24.MyAVLTree.MyAVLTree1.Node;

public class MyAVLTreeTest {

	public static void main(String[] args) {
		MyAVLTree1<Integer, Integer> map = new MyAVLTree1<>();
	...
	private static void printInOrder(MyAVLTree1<Integer, Integer> map) {
		for(Node node: map) {
	...
	private static void printBalanceFactor(MyAVLTree1<Integer, Integer> map) {
		int minHeight = 1;
		for(Node node: map) {
			if (node.getHeight() == 0) {
				minHeight = 0;
